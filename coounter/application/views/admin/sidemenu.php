...
<div class="copyrights">
	 <p>© 2019	E-Coounter	version	1.0  <a href="http://w3layouts.com/" target="_blank"></a> </p>
</div>	
    ...
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li id="menu-comunicacao" ><a href="#"><i class="fa fa-book nav_icon"></i><span>Form Utama</span><span class="fa fa-angle-right" style="float: right"></span></a>
